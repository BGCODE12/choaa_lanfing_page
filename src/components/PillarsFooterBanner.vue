...
const pillars = [
  {
    ...
    titleKey: 'pillars.heritageTitle',
  ...
  {
    icon: 'mdi-auto-stories',
    titleKey: 'pillars.knowledgeTitle',
    descKey: 'pillars.knowledgeDesc',
  },
  {
    icon: 'mdi-account-group-outline',
    titleKey: 'pillars.futureTitle',
    descKey: 'pillars.futureDesc',
  },
]
</script>
